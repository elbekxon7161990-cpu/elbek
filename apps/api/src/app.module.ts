 ...
 * TASK-SEC-006's `SupportSessionHttpModule`). No BullMQ producer/consumer
 * module is imported here yet — nothing in this skeleton enqueues a job —
 * and no Telegraf/bot module is imported at all, per "each bootstrap loads
 * only the modules it requires."
 */
@Module({
  imports: [
